...
<body>
        ...
        <header class="topbar" data-navbarbg="skin6">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand ms-4" href="owner">
                        <!-- Logo icon -->
                        <b class="logo-icon">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body profile-card">
                                <center class="mt-4"> <img src="{{ asset('template/assets/images/users/5.jpg') }}"
    ...
    <script src="{{ asset('teplate/html/js/app-style-switcher.js') }}"></script>
    <!--Wave Effects -->
