<x-app-layout>
                 ...
                 <table class="min-w-full leading-normal">
                     ...
                     <tbody>
                         ...
                         <tr>
                             ...
                             <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                 <p class="text-gray-900 whitespace-no-wrap">{{ $data->nama_produk }}</p>
                             </td>
                             <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                             ...
                             <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm flex space-x-2">
                                 <button onclick="openModalEdit()" class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-700">Edit</button>
    ...
    <!-- Modal Edit -->
    <div id="EditProductModal" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75 hidden">
        <div class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all max-w-lg w-full">
            <div class="px-6 py-4">
                <div class="flex justify-between items-center">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Tambah Produk</h3>
                    <button onclick="closeModalEdit()" class="text-gray-400 hover:text-gray-500">
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/>
                        </svg>
                    </button>
                ...
                <div class="mt-4">
                    <form id="EditProductForm" action="{{ route ('product.update') }}" method="POST">
                         @csrf
                        <div class="mb-4">
                            <label for="id" class="block text-sm font-medium text-gray-700">ID Produk</label>
                            <input type="text" id="id" name="id" class="mt-1 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full">
                        ...
                        <div class="flex justify-end">
                            <button type="button" onclick="closeModalEdit()" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-700">Batal</button>
                            <button type="submit" class="ml-2 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">Simpan</button>
                        </div>
                    </form>
                </div>
